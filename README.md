...
The development environment is configured to work out-of-the-box using default settings defined in `compose.yaml`. These defaults are suitable for most local development.
